...
class MercadoArtificial(SearchProblem):
    ...
    def heuristic(self, state):
        paquetes = state[1]
        return len([paquete for paquete in paquetes if paquetes[1] != paquetes[2]])
    ...
    def result(self, state, action):
        ...
        for paquete in paquetes:
            ...
            if paquete in paquetes_transportados:
...
if __name__ == "__main__":
    planear_camiones(
        ...
        viewer=viewers.WebViewer("127.0.0.1", port=8080)
    )
